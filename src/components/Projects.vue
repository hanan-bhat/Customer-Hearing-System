...
// const toolTipForPrivate = ref('Private - Project access must be granted explicitly to each user. If this project is part of a group, access is granted to members of the group.'
// )
...
onMounted(() => {
  ...
  console.log('CHECK FROM PROJECTS PAGE: ', store.state.issues)
})
</script>
