...
const iid = router.currentRoute.value.query.iid
...
<template>
  <div class="mt-5">
    <section
      v-if="editor"
      class="rounded-t-xl buttons text-slate-600 flex items-center flex-wrap gap-x-4 border-t border-l border-r border-slate-200 p-4"
    >
      <button
        type="button"
